...
def get_args():
    ...
    parser.add_argument('--monitor_freq', type=int, help='frequency of showing results during training.')
    ...
    parser.add_argument('--lr_clf', type=float, default=0.0005)
    parser.add_argument('--lr_seg', type=float, default=0.00025)
    ...
    if args.monitor_freq is None:
        if args.task == 'clf':
            args.monitor_freq = 1000
        elif args.task == 'seg':
            args.monitor_freq = 100
