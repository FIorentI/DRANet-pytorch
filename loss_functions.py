...
def loss_weights(task, dsets):
    ...
    if task == 'clf':
        ...
        # EMNIST <-> DAGECC
        elif 'EMNIST' in dsets and 'DAGECC' in dsets and 'U' not in dsets:
            alpha['style']['EMNIST2DAGECC'], alpha['style']['DAGECC2EMNIST'] = 5e4, 1e4
            alpha['dis']['EMNIST'], alpha['dis']['DAGECC'] = 0.5, 0.5
            alpha['gen']['EMNIST'], alpha['gen']['DAGECC'] = 0.5, 1.0

        # EMNIST <-> DAGECC
        elif 'SYN' in dsets and 'DAGECC' in dsets and 'U' not in dsets:
            alpha['style']['SYN2DAGECC'], alpha['style']['DAGECC2SYN'] = 5e4, 1e4
            alpha['dis']['SYN'], alpha['dis']['DAGECC'] = 0.5, 0.5
            alpha['gen']['SYN'], alpha['gen']['DAGECC'] = 0.5, 1.0
