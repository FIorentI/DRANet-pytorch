...
# to check https://stackoverflow.com/questions/56235733/is-there-a-tensor-operation-or-function-in-pytorch-that-works-like-cv2-dilate
# from https://github.com/lc82111/pytorch_morphological_dilation2d_erosion2d/blob/master/morphology.py
...
class Morphology(nn.Module):
    ...
    def forward(self, x):
        ...
        x = x.view(-1, self.out_channels, height, width)  # (B, Cout, L/2, L/2)
...
if __name__ == '__main__':
    ...
    e = Erosion2d(3, 3, 3, soft_max=False)
    y = e(x)
